...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/vocabulary/<vocabulary-id> \
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/widget/<widget-id>/vocabulary/<vocabulary-id> \
-H "Content-Type: application/json"  -d \
 '{
   "tags": [<tags>]
  }'
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/layer/<layer-id>/vocabulary/<vocabulary-id> \
-H "Content-Type: application/json"  -d \
 '{
   "tags": [<tags>]
  }'
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/942b3f38-9504-4273-af51-0440170ffc86/vocabulary/science
-H "Content-Type: application/json"  -d \
 '{
...
```shell
curl -X PATCH https://api.apihighways.org/v1/dataset/<dataset-id>/vocabulary/<vocabulary-id> \
-H "Content-Type: application/json"  -d \
 '{
   "tags": [<tags>]
  }'
...
```shell
curl -X PATCH https://api.apihighways.org/v1/dataset/<dataset-id>/widget/<widget-id>/vocabulary/<vocabulary-id> \
-H "Content-Type: application/json"  -d \
 '{
   "tags": [<tags>]
  }'
...
```shell
curl -X PATCH https://api.apihighways.org/v1/dataset/<dataset-id>/layer/<layer-id>/vocabulary/<vocabulary-id> \
-H "Content-Type: application/json"  -d \
 '{
   "tags": [<tags>]
  }'
...
```shell
curl -X PATCH https://api.apihighways.org/v1/dataset/942b3f38-9504-4273-af51-0440170ffc86/vocabulary/science
-H "Content-Type: application/json"  -d \
 '{
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/vocabulary \
-H "Content-Type: application/json"  -d \
 '{
   "vocabularyOne": {
       "tags": [<tags>]
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/widget/<widget-id>/vocabulary\
-H "Content-Type: application/json"  -d \
'{
  "vocabularyOne": {
      "tags": [<tags>]
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/layer/<layer-id>/vocabulary \
-H "Content-Type: application/json"  -d \
'{
  "vocabularyOne": {
      "tags": [<tags>]
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/942b3f38-9504-4273-af51-0440170ffc86/vocabulary
-H "Content-Type: application/json"  -d \
 '{
     "country": {
...
```shell
curl -X DELETE https://api.apihighways.org/v1/dataset/<dataset-id>/vocabulary/<vocabulary-id>
```

```shell
curl -X DELETE https://api.apihighways.org/v1/dataset/<dataset-id>/widget/<widget-id>/vocabulary/<vocabulary-id>
```

```shell
curl -X DELETE https://api.apihighways.org/v1/dataset/<dataset-id>/layer/<layer-id>/vocabulary/<vocabulary-id>
```

> real example

```shell
curl -X DELETE https://api.apihighways.org/v1/dataset/942b3f38-9504-4273-af51-0440170ffc86/vocabulary/science
```
...
```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/vocabulary
```

```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/widget/<widget-id>/vocabulary
```

```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/layer/<layer-id>/vocabulary
```

> real example

```shell
curl -X GET https://api.apihighways.org/v1/dataset/942b3f38-9504-4273-af51-0440170ffc86/vocabulary
```
...
```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/vocabulary/<vocabulary-id>
```

```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/widget/<widget-id>/vocabulary/<vocabulary-id>
```

```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/layer/<layer-id>/vocabulary/<vocabulary-id>
```
...
```shell
curl -X GET https://api.apihighways.org/v1/dataset/vocabulary/find
```

```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/widget/vocabulary/find
```

```shell
curl -X GET https://api.apihighways.org/v1/dataset/<dataset-id>/layer/vocabulary/find
```

> real example

```shell
curl -X GET http://api.apihighways.org/v1/dataset/vocabulary/find?legacy=cdi,coasts
```
...
```shell
curl -X GET https://api.apihighways.org/v1/vocabulary
```
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/vocabulary/find-by-ids \
-H "Content-Type: application/json"  -d \
 '{
   "ids": [<ids>]
  }'
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/widget/vocabulary/find-by-ids \
-H "Content-Type: application/json"  -d \
 '{
   "ids": [<ids>]
  }'
...
```shell
curl -X POST https://api.apihighways.org/v1/dataset/<dataset-id>/layer/vocabulary/find-by-ids \
-H "Content-Type: application/json"  -d \
 '{
   "ids": [<ids>]
  }'
...
```shell
curl -X POST https://api.apihighways.org/v1/vocabulary/vocabularyName \
-H "Content-Type: application/json"  -d \
 '{
   "name": <vocabularyName>
  }'
